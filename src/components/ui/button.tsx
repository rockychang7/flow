...
// hover 只换颜色,不做位移/缩放/浮起;阴影仅 shadow-xs 一档
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default:
                    "bg-foreground text-background shadow-xs hover:bg-muted-foreground",
                destructive:
                    "bg-destructive text-background shadow-xs hover:opacity-90",
                outline:
                    "border border-input bg-background shadow-xs hover:bg-muted",
                secondary: "bg-muted text-foreground hover:text-muted-foreground",
